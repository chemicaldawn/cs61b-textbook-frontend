---
title: References, Recursion, and Lists
section: 3
slug: references-recursion-and-lists
---
...
The top bits represent -1431195969, and the bottom bits represent 567213.112. Why these specific sequences of bits represent these two numbers is not important, and is a topic covered in CS61C. However, if you're curious, see [integer representations](https://en.wikipedia.org/wiki/Two's_complement) and [double representations](https://en.wikipedia.org/wiki/IEEE_floating_point) on wikipedia.
...
#### == vs. Arrays.equals <a href="#instantiation-of-arrays" id="instantiation-of-arrays"></a>
